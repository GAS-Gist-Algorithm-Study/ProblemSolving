...
int main(){
    ...
    */
    ...
    while(CCW(convexHull[convexHull.size()-2], convexHull[convexHull.size()-1], convexHull[0]) <= 0)
        convexHull.pop_back();
    
    /*
    cout << "*" << endl;
    for(int i=0; i< convexHull.size();i++) cout << convexHull[i].x << " " << convexHull[i].y << endl;
    */
